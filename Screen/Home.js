      ...
      >
        ...
        <View style={styles.searchContainer}>
          <View style={styles.searchBar}>
            <Ionicons name="search" size={20} color="#D4A017" style={styles.searchIcon} />
            <TextInput 
            ...
            {searchText.length > 0 && (
              <TouchableOpacity onPress={() => setSearchText("")}> 
                <Ionicons name="close" size={20} color="#D4A017" style={styles.closeIcon} />
              </TouchableOpacity>
            )}
          </View>
        </View>

        {/* Header Image - Hide When Searching */}
        {!isSearching && (
          <View style={styles.headerContainer}>
            <Image 
              source={{ uri: "https://i.pinimg.com/474x/3a/a2/09/3aa2093ae124d72c42e8b5411d396f6c.jpg" }} 
        ...
        <View style={[styles.categoryGrid, isSearching && styles.dimmedContent]}>
          {filteredCategories.length > 0 ? (
            filteredCategories.map((category, index) => (
              <TouchableOpacity 
  key={index} 
  style={styles.categoryBox} 
  onPress={() => navigation.navigate("WorkersList", { category: category.name })}
>
  ...
  <Text style={styles.categoryText}>{category.name}</Text>
      ...
      {/* Bottom Navigation - Disable When Searching */}
